...
class MainViewController: UIViewController, UIActionSheetDelegate, UITextFieldDelegate {
    
    private var observers: [AnyCancellable] = []
    var dataSource: MainDataSource?
    
    var storage = TransactionKeyValueStore(storage: DictionaryStore())
    
    var action = TSButtonAction.get {
        didSet {
            updateSubviews()
        }
    }
    ...
    private lazy var actionButton: TSButton = {
        let button = TSButton()
    ...
    private lazy var goButton: TSButton = {
        let button = TSButton()
    ...
    private lazy var keyTextField: TSTextField = {
    ...
    private lazy var valueTextField: TSTextField = {
        let textField = TSTextField()
    ...
    private func handleTextFieldResponse(response: TSTextFieldPassthroughSubject) {
    ...
    private func onGetTapped() {
        ...
        let actionResponse = storage.get(key: key)
    ...
    private func onCountTapped() {
        ...
        let keysCount = storage.count(value: value)
